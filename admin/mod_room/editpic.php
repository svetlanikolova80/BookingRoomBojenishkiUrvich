    ...
    <div class="panel-body">
        <form class="form-horizontal well span6" action="controller.php?action=editimage" enctype="multipart/form-data" method="POST">
            <table class="table table-hover" border="0" width="50">
                <caption>
                    <h3 align="left">Промени картинка</h3>
                </caption>
                <tr>
                    <td width="80">
                        <input name="id" type="hidden" value="<?php echo $_SESSION['id']; ?>">
                        <img src="<?php echo $cur->roomImage; ?>" width="300" height="300" />
                    </td>
                </tr>
                <tr>
                    <td width="80">
                ...
                <tr>
                    <td width="80"><input type="button" value="&laquo Назад" class="btn btn-primary" onclick="window.location.href='index.php'" >  
